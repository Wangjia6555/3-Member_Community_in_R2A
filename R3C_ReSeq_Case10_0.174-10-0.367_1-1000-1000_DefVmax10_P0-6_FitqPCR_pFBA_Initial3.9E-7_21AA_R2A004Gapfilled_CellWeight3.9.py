...
#YR343
YR343.change_bounds('EX_cpd00027_e0',-0.174,1000) #####Glucose 
...
YR343.change_bounds('EX_cpd00023_e0',-0.174,1000) #####Glutamate

YR343.change_bounds('EX_cpd00028_e0',-1000,1000) # #Heme

YR343.change_bounds('EX_cpd00030_e0',-1000,1000) #Mn2+

YR343.change_bounds('EX_cpd00033_e0',-0.174,1000) #####Glycine

YR343.change_bounds('EX_cpd00034_e0',-1000,1000) #Zn2+

YR343.change_bounds('EX_cpd00035_e0',-0.174,1000) #####Alanine
YR343.change_bounds('EX_cpd00039_e0',-0.174,1000) #####Lysine
YR343.change_bounds('EX_cpd00041_e0',-0.174,1000) #####Aspartate

YR343.change_bounds('EX_cpd00046_e0',-1000,1000) #CMP

YR343.change_bounds('EX_cpd00048_e0',-1000,1000) #Sulfate

YR343.change_bounds('EX_cpd00051_e0',-0.174,1000) #####Arginine

YR343.change_bounds('EX_cpd00053_e0',-0.174,1000) #####Glutamine

YR343.change_bounds('EX_cpd00054_e0',-0.174,1000) #####Serine

YR343.change_bounds('EX_cpd00058_e0',-1000,1000) #Cu2+

YR343.change_bounds('EX_cpd00060_e0',-0.174,1000) #####Methionine

YR343.change_bounds('EX_cpd00063_e0',-1000,1000) #Ca2+

YR343.change_bounds('EX_cpd00065_e0',-0.174,1000) #####Tryptophan
YR343.change_bounds('EX_cpd00066_e0',-0.174,1000) #####Phenylalanine

YR343.change_bounds('EX_cpd00067_e0',-1000,1000) #H+

YR343.change_bounds('EX_cpd00069_e0',-0.174,1000) #####Tyrosine

YR343.change_bounds('EX_cpd00084_e0',-0.174,1000) #####Cysteine
...
YR343.change_bounds('EX_cpd00107_e0',-0.174,1000) #####Leucine
YR343.change_bounds('EX_cpd00119_e0',-0.174,1000) #####Histidine

YR343.change_bounds('EX_cpd00126_e0',-1000,1000) #GMP

YR343.change_bounds('EX_cpd00129_e0',-0.174,1000) #####Proline

YR343.change_bounds('EX_cpd00132_e0',-0.174,1000) #####Asparagine

YR343.change_bounds('EX_cpd00149_e0',-1000,1000) #Co2+

YR343.change_bounds('EX_cpd00156_e0',-0.174,1000) #####Valine
YR343.change_bounds('EX_cpd00161_e0',-0.174,1000) #####Threonine
...
YR343.change_bounds('EX_cpd00322_e0',-0.174,1000) #####Isoleucine
YR343.change_bounds('EX_cpd00381_e0',-0.174,1000) #####Cystine
...
#AP49
AP49.change_bounds('EX_cpd00027_e0',-0.367,1000) #####Glucose
...
AP49.change_bounds('EX_cpd00023_e0',-0.367,1000) #####Glutamate

AP49.change_bounds('EX_cpd00028_e0',-1000,1000) # #Heme

AP49.change_bounds('EX_cpd00030_e0',-1000,1000) #Mn2+

AP49.change_bounds('EX_cpd00033_e0',-0.367,1000) #####Glycine

AP49.change_bounds('EX_cpd00034_e0',-1000,1000) #Zn2+

AP49.change_bounds('EX_cpd00035_e0',-0.367,1000) #####Alanine
AP49.change_bounds('EX_cpd00039_e0',-0.367,1000) #####Lysine
AP49.change_bounds('EX_cpd00041_e0',-0.367,1000) #####Aspartate

AP49.change_bounds('EX_cpd00046_e0',-1000,1000) #CMP

AP49.change_bounds('EX_cpd00048_e0',-1000,1000) #Sulfate

AP49.change_bounds('EX_cpd00051_e0',-0.367,1000) #####Arginine

AP49.change_bounds('EX_cpd00053_e0',-0.367,1000) #####Glutamine

AP49.change_bounds('EX_cpd00054_e0',-0.367,1000) #####Serine

AP49.change_bounds('EX_cpd00058_e0',-1000,1000) #Cu2+

AP49.change_bounds('EX_cpd00060_e0',-0.367,1000) #####Methionine

AP49.change_bounds('EX_cpd00063_e0',-1000,1000) #Ca2+

AP49.change_bounds('EX_cpd00065_e0',-0.367,1000) #####Tryptophan
AP49.change_bounds('EX_cpd00066_e0',-0.367,1000) #####Phenylalanine

AP49.change_bounds('EX_cpd00067_e0',-1000,1000) #H+

AP49.change_bounds('EX_cpd00069_e0',-0.367,1000) #####Tyrosine

AP49.change_bounds('EX_cpd00084_e0',-0.367,1000) #####Cysteine
...
AP49.change_bounds('EX_cpd00107_e0',-0.367,1000) #####Leucine
AP49.change_bounds('EX_cpd00119_e0',-0.367,1000) #####Histidine

AP49.change_bounds('EX_cpd00126_e0',-1000,1000) #GMP

AP49.change_bounds('EX_cpd00129_e0',-0.367,1000) #####Proline

AP49.change_bounds('EX_cpd00132_e0',-0.367,1000) #####Asparagine

AP49.change_bounds('EX_cpd00149_e0',-1000,1000) #Co2+

AP49.change_bounds('EX_cpd00156_e0',-0.367,1000) #####Valine
AP49.change_bounds('EX_cpd00161_e0',-0.367,1000) #####Threonine
...
AP49.change_bounds('EX_cpd00322_e0',-0.367,1000) #####Isoleucine
AP49.change_bounds('EX_cpd00381_e0',-0.367,1000) #####Cystine
...
# YR343-GM17-AP49 = 1-1000-1000 (GM17-YR343-AP49 = 1 - 0.001 - 1)
